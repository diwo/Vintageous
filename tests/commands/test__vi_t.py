...
TEST_MULTI_CHAR_CASES = (
	test_data('0ab3x5', (1, 3), 'x', (1, 4), 'Forward'),
	test_data('0a23x5', (1, 5), 'x', (1, 5), 'Forward find b'),
	test_data('0b2xa5', (5, 1), 'x', (5, 2), 'Reverse no crossover'),
	test_data('0ba3x5', (3, 1), 'x', (2, 4), 'Reverse crossover'),
	test_data('0b2x45', (4, 1), 'x', (4, 2), 'Reverse find a'),
	test_data('0x2a45', (4, 1), 'x', (4, 1), 'Reverse find b'),
	test_data('0a2bx5', (1, 4), 'x', (1, 4), 'Forward find b+1'),
	test_data('0bx3a5', (5, 1), 'x', (5, 1), 'Reverse find b+1'),
	test_data('0b2ax5', (4, 1), 'x', (4, 3), 'Reverse find a+1'),
)

TEST_ONE_CHAR_CASES = (
	test_data('ax', (0, 2), 'x', (0, 2), 'Forward find b'),
	test_data('bx', (2, 0), 'x', (2, 0), 'Reverse find a'),
	test_data('fx', (0, 1), 'x', (0, 1), 'Forward find next'),
	test_data('rx', (1, 0), 'x', (1, 0), 'Reverse find next'),
	test_data('f',  (0, 1), 'f', (0, 1), 'Forward find self'),
	test_data('r',  (1, 0), 'r', (1, 0), 'Reverse find self'),
)

TEST_MULTI_MATCHES_CASES = (
	test_data('0abxx5', (1, 3), 'x', (1, 3), 'Forward find first'),
	test_data('0axx45', (1, 3), 'x', (1, 3), 'Forward find b'),
	test_data('0bxx45', (3, 1), 'x', (3, 1), 'Reverse find a'),
	test_data('0bxx45', (4, 1), 'x', (4, 1), 'Reverse find a'),
	test_data('0xax45', (3, 1), 'x', (3, 2), 'Reverse find b'),
)

class Test_t_visual_mode(ViewTest):
	def runTests(self, data):
		for (i, data) in enumerate(data):
			...
			self.view.run_command('_vi_find_in_line',
				{'mode': modes.VISUAL, 'count': 1, 'char': data.findChar, 'inclusive': False})
